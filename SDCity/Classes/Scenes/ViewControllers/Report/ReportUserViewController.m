...
//  Starrunning
//
//  Created by wangweidong on 2017/8/2.
...
@interface ReportUserViewController ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)loadNavigation{
    ...
    self.navigationItem.title = @"举报用户";
...
-(UITableView *)mainTableView{
    ...
    if (_mainTableView == nil) {
        _mainTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, StatusHeight+44, KmainWidth, KmainHeight-StatusHeight-44) style:UITableViewStylePlain];
...
-(UIButton *)reportButton{
    ...
    if (_reportButton == nil) {
        ...
        _reportButton.backgroundColor = [SDUtils hexStringToColor:KmainColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSArray *dataArray = @[@"恶意骚扰",@"垃圾广告",@"恶意诈骗",@"不良信息",@"违法乱纪",@"其他"];
...
-(void)reportAction{
    ...
    if (isNoSelect) {
        ...
        [SVProgressHUD showSuccessWithStatus:@"举报用户成功!"];
        KweakSelf(self);
